...
- Native Manga tab powered by MangaKatana scraping, with search, manga details, chapter lists, and a vertical reader.
...
- URLSession for manga catalog, search, detail, and reader pages through the resolver backend.
